...
*/
(function(){
    var k=Highcharts,y=k.Chart,C=k.addEvent,t=k.createElement,z=k.discardElement,u=k.css,w=k.merge,p=k.each,r=k.extend,D=Math.max,s=document,E=window,A="ontouchstart"in s.documentElement,B=k.setOptions({
        lang:{
...
r(y.prototype,{
    getSVG:function(b){
        ...
        if(!s.createElementNS)s.createElementNS=function(i,g){
            ...
            o.getBBox=function(){
                return k.Renderer.prototype.Element.prototype.getBBox.apply({
                    element:o
                })
                };
...
contextMenu:function(b,c,a,f,d,l){
    ...
    if(!n){
        ...
        p(c,function(v){
            ...
            r({
                cursor:"pointer"
            },h),q)[A?"ontouchstart":"onclick"]=function(){
                x();
